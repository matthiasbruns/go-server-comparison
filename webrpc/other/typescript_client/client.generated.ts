...
//
// webrpc-gen -schema=schema.ridl -target=typescript -client -out=other/typescript_client/client.generated.ts
...
// Client
//
export class HelloWorldV1 implements HelloWorldV1 {
  protected hostname: string
  protected fetch: Fetch
  protected path = '/rpc/HelloWorldV1/'
